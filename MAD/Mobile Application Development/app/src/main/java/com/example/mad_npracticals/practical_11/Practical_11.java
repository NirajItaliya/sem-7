package com.example.mad_npracticals.practical_11;
...
import com.example.mad_npracticals.practical_11.util.CourseRVAdapter;
import com.example.mad_npracticals.practical_11.util.CourseRVModal;
...
public class Practical_11 extends AppCompatActivity implements CourseRVAdapter.CourseClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addCourseFAB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Practical_11.this, AddCourseActivity.class);
                startActivity(i);
            }
        });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            case R.id.idLogOut:
                ...
                Intent i = new Intent(Practical_11.this, LoginActivity.class);
                startActivity(i);
               // this.finish();
                return true;
            default:
    ...
    private void displayBottomSheet(CourseRVModal modal) {
        ...
        final BottomSheetDialog bottomSheetTeachersDialog = new BottomSheetDialog(this, R.style.button_wh);
        ...
        Picasso.with(getApplicationContext()).load(modal.getCourseImg()).into(courseIV);
        ...
        editBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Practical_11.this, EditCourseActivity.class);
