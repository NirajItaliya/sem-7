...
public class EditCourseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bestSuitedEdt = findViewById(R.id.etEditSuitedFor);
        courseImgEdt = findViewById(R.id.etEditCourseImg);
        courseLinkEdt = findViewById(R.id.etEditCourseLink);
        courseDescEdt = findViewById(R.id.etEditCourseDescription);
        loadingPB = findViewById(R.id.idPBLoading);
        firebaseDatabase = FirebaseDatabase.getInstance();
        // on below line we are getting our modal class on which we have passed.
        courseRVModal = getIntent().getParcelableExtra("course");
        Button deleteCourseBtn = findViewById(R.id.btnEditDeleteCourse);
            ...
            public void onClick(View v) {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Intent getCourses = new Intent(EditCourseActivity.this, Practical_11.class);
                        getCourses.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(getCourses);
                    }
    ...
    private void deleteCourse() {
        ...
        startActivity(new Intent(EditCourseActivity.this, Practical_11.class));
    }
}